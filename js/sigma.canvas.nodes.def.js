...
(function () {
    ...
    sigma.canvas.nodes.def = function (node, context, settings, options) {
        var o = options || {},
            ...
            borderColor = settings('nodeBorderColor') === 'default' ? settings('defaultNodeBorderColor') : (o.borderColor || node.border_color || defaultNodeColor),
        ...
        if (node.active) {
            ...
            if (node.secondaryActive) {
                color = settings('secondaryActiveColor');
            } else {
            ...
            if (outerBorderSize > 0) {
                context.beginPath();
                context.strokeStyle = node.secondaryActive ? settings('secondaryActiveColor') :
                    settings('nodeOuterBorderColor') === 'node' ?
